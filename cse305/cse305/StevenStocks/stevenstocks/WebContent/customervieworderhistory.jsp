...
<%@page import="settings.ViewOrderHistory" %>
...
<body>
	...
	<div id="main-container">
		<div id="heading-container">
			<form id='back-stock-search'action="OrderSearchCustomer" method="post">
				<a href="javascript:{}" onclick="document.getElementById('back-stock-search').submit();">Back</a>
			</form>		
	 		<h1>History for order: <%=orderNumber%></h1><hr id="title-line">	 	 
		</div>
			...
			<script type="text/javascript">
				...
				var myLineChart = Chart.Line(stockHistory, {data: stockData, options: {responsive: true,maintainAspectRatio: true, tension:10}});
			</script>
	</div>
