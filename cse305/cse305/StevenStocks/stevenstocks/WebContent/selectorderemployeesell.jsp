...
<body>
	...
	<div id="main-container">
		<div id="heading-container">
			<form id='back-to-stock'action="CustomerViewStockByAccount" method="post">
				<input type="hidden" name="accountnumber" value="<%=accountNumber%>">
	        	<a href="javascript:{}" onclick="document.getElementById('back-to-stock').submit();">Back</a>
	        </form> 
	 		<h1>Sell Stock</h1><hr id="title-line">
		</div>	
		
		<div id="customer-form-container">
			<div class="col">
				<form  class="customer-form" action="CustomerSellStockFinal" method="post">
