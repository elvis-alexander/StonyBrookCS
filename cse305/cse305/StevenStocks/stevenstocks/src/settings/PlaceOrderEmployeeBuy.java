...
/**
 * Servlet implementation class PlaceOrderEmployeeBuy
 */
@WebServlet("/PlaceOrderEmployeeBuy")
public class PlaceOrderEmployeeBuy extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public PlaceOrderEmployeeBuy() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			System.out.println("Employee id: " + request.getSession().getAttribute("user_ssn"));
			stmt.executeUpdate("INSERT INTO trade VALUES (" + String.format("%s, %s, %s, %s);", accountNumber, orderNumber, transactionID, (String) request.getSession().getAttribute("user_ssn")));
...
//				totalAmountOfSharesCurrentlyAvailable
			...
			RequestDispatcher rd = request.getRequestDispatcher("confirmemployeebuy.jsp");
