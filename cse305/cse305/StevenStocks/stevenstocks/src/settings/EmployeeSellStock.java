 ...
 */
@WebServlet("/EmployeeSellStock")
public class EmployeeSellStock extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public EmployeeSellStock() {
        super();
		...
		// utilities
				...
				String url = "jdbc:mysql://mysql2.cs.stonybrook.edu:3306/blanunez";
		  		...
		  		try {
					...
					request.setAttribute("customerfirstname",request.getParameter("customerfirstname"));
					request.setAttribute("customerlastname",request.getParameter("customerlastname"));
					request.setAttribute("customerid",request.getParameter("customerid"));
					// redirect
					conn.close();
					
					RequestDispatcher rd = request.getRequestDispatcher("employeesellstock.jsp");			
