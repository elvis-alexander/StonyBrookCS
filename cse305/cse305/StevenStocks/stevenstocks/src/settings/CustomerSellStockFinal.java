...
/**
 * Servlet implementation class CustomerSellStockFinal
 */
@WebServlet("/CustomerSellStockFinal")
public class CustomerSellStockFinal extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CustomerSellStockFinal() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		// order_, transaction_, trade, hasstock;
		// utilities
...
//				totalAmountOfSharesCurrentlyAvailable
			...
			RequestDispatcher rd = request.getRequestDispatcher("confirmcustomersell.jsp");
